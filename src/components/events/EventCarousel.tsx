	...
	return (
		<div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-10">
			<div className="relative">
				...
				<div className="absolute inset-y-0 left-0 w-16 md:w-24 bg-gradient-to-r from-gray-50 to-transparent pointer-events-none z-10" />
				<div className="absolute inset-y-0 right-0 w-16 md:w-24 bg-gradient-to-l from-gray-50 to-transparent pointer-events-none z-10" />
			</div>
